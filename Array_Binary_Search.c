...
Discription: This program will take the array values from the user and allows to user to search an element. If the element is found the algoritm will return the index.
